    ...
    <div class="container content-center">
      <form v-on:submit="addTodo($event)">
        <div class="form-group mt-3">
          ...
          />
          <textarea
            placeholder="Add or edit a description"
      ...
      <ul style="list-style-type: none;">
        <li
          ...
          :key="todo._id"
          class="border border-dark rounded mt-3 text-center"
        >
          <button
          ...
          <button
            ...
            @click="changeState(todo._id, todo.state)"
          >
            Complete
          </button>

          <button
            v-else-if="todo.state === 'complete'"
